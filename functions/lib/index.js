...
exports.getQuizForStudent = exports.submitQuizAttempt = exports.startQuizAttempt = exports.onCourseDelete = void 0;
...
exports.onCourseDelete = (0, firestore_1.onDocumentDeleted)({
    ...
    const attemptsDeleted = await deleteAllDocs(db.collection("quizAttempts").where("courseId", "==", courseId));
...
exports.getQuizForStudent = quizzes_1.getQuizForStudent;
